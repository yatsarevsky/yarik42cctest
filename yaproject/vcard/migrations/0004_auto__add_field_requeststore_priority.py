...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('vcard_requeststore', 'priority',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('vcard_requeststore', 'priority')
    ...
    models = {
        ...
        'vcard.entrylog': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 12, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
